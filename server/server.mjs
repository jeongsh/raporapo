import { reactive, hasInjectionContext, getCurrentInstance, effectScope, ref, markRaw, toRaw, isRef, isReactive, toRef, inject, watch, unref, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, version, watchEffect, isShallow, shallowRef, isReadonly, h, defineComponent, Transition, Suspense, provide, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
const appHead = { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1, shrink-to-fit=no" }, { "name": "description", "content": "현실과 가상 속에서의 라포를 형성시킬 수 있는 서비스. 온/오프라인 연계 기반의 게이미피케이션 서비스와 콘텐츠를 제공합니다." }], "link": [], "style": [], "script": [], "noscript": [], "htmlAttrs": { "lang": "ko" }, "title": "RAPORAPO" };
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-43e68da0.js").then((m) => m.default || m)
  },
  {
    name: "qrquiz",
    path: "/qrquiz",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-6aa2eebb.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-b83c7b70.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-db1e84d3.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
